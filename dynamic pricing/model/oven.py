...
def appliance_oven():
    ...
    clothes_data = pd.read_csv("model/appliances.csv")  # Assuming your CSV has columns "description" and "price"
    ...
    #print("-" * 50)  # Optional separator between products
